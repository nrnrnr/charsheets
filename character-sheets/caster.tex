...
\node [dndbox,below left corner=5mm of carrying,fill=equipment,inner sep=15pt] 
   (heavy equipment)
{
...
\node [dndbox,slotblock,below right corner=5mm of heavily,fill=equipment,minimum height= 82\tenthstoneheight]
  (small items)
  { }
;
