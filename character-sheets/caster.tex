...
\node (encumbered) [dndencumbrance,fill=encumbered,below=of banner,dndlabel=ENCUMBERED] 
  {\Large\ifDNDnonempty{STR}{$\mathbf{\geq\renderstones{\arabic{encumberedThreshold}}}$}{emptyb
  STR?}};

\node (carrying) [dndencumbrance,fill=carrying,left=5mm of encumbered,dndlabel=CARRYING CAPACITY]
...
\node (slotspace) [slotblock,minimum height=\dimexpr\greenheight+\yellowheight+\redheight+10mm\relax,fill=white,right=of current bounding box.west,anchor=west] { };

\node (slotgreen) [slotblock,fill=unencumbered,anchor=north west,
                   minimum height=\dimexpr\greenheight+10mm\relax]
  at (slotspace.north west) {DEBUG: \arabic{greenLines} slots} ;
...
% \path (slots.north) ++(0,-10mm) coordinate (lastslot);
%
...
\node [below=10mm of encumbered,anchor=north] {
  ...
  \ifnum\value{HEAVY WEAPONS stones}>0 \relax
  Heavy weapons & \renderstones{\value{HEAVY WEAPONS stones}} \\
  \fi
  \ifnum\value{NORMAL WEAPONS stones}>0 \relax
  Normal weapons & \renderstones{\value{NORMAL WEAPONS stones}} \\
  \fi
  \ifnum\value{LIGHT WEAPONS stones}>0 \relax
  Light weapons & \renderstones{\value{LIGHT WEAPONS stones}} \\
  \fi
  \ifnum\value{SHIELDS stones}>0 \relax
  Shields & \renderstones{\value{SHIELDS stones}} \\
  \fi
  \ifnum\value{HEAVY ARMOR stones}>0 \relax
  Heavy armor & \renderstones{\value{HEAVY ARMOR stones}} \\
  \fi
  \ifnum\value{NORMAL ARMOR stones}>0 \relax
  Normal armor & \renderstones{\value{NORMAL ARMOR stones}} \\
  \fi
  \ifnum\value{LIGHT ARMOR stones}>0 \relax
  Light armor & \renderstones{\value{LIGHT ARMOR stones}} \\
  \fi
  \ifnum\value{HEAVY ITEMS stones}>0 \relax
  Heavy items & \renderstones{\value{HEAVY ITEMS stones}} \\
  \fi
  \ifnum\value{SLOTTED ITEMS stones}>0 \relax
  Slotted items & \renderstones{\value{SLOTTED ITEMS stones}} \\
  \fi
  \ifnum\value{FREE ITEMS stones}>0 \relax
  Free items & \renderstones{\value{FREE ITEMS stones}} \\
  \fi
  \bottomrule
  \end{tabular}
};
