...
\node (encumbered) [dndencumbrance,fill=encumberedcolor,below=of banner,dndlabel=ENCUMBERED] 
...
\node (slots) [dndbox,minimum width=60mm,right=of current bounding box.west,anchor=west] {
  \begin{minipage}{60mm}
  \vspace*{\greenheight+\yellowheight+\redheight+10mm\relax}
  \end{minipage}
 }
 ;
