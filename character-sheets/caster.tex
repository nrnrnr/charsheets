...
\ifDNDnonempty{STR}{%
  ...
  \pgfmathtruncatemacro{\tempgreenlines}{(\value{encumberedThreshold}-\value{significantWeight}) * 5 / 10}%
  \setcounter{greenLines}{\tempgreenlines}%
  \pgfmathtruncatemacro{\tempyellowlines}{(\value{heavilyEncumberedThreshold} - \value{encumberedThreshold}) * 5 / 10}%
  \setcounter{yellowLines}{\tempyellowlines}%
  \pgfmathtruncatemacro{\tempredlines}{(\value{carryingCapacity} - \value{heavilyEncumberedThreshold}) * 5 / 10}%
  \setcounter{redLines}{\tempredlines}%
}{%
