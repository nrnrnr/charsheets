...
%  \setcounter{proficiency bonus}{2}
  ...
  \draw ($(splash.south west)+(48mm,16mm)$) coordinate  (charname center)
     ;
...
\begin{features}[anchor=south east,at=(current bounding box.south -| magic.east)]{}
...
\firsttwoDNDdefined{\upper}{\upperlabel}{\lower}{\lowerlabel}{SORCERY POINTS}{SENSES}{SPELL DC}{PASSIVE PERCEPTION}

%\typeout{upper is \upperlabel; lower is \lowerlabel}
...
%\show\upperlabel
  ...
  \node (upper val)
      ...
      \dndlabel[\upperlabel]{upper val}{\upperlabel}

   \node (lower val)
      [dndmaxhp,left=10mm of curhp,width=24mm] 
      {\Large\textsf{\lower}}
      ;
   \dndlabel[\upperlabel]{lower val}{\lowerlabel}


\node [draw,above=of features] {7 slots: minimum \minrows{7} rows\par \stackslots7\par!\slots4!};
