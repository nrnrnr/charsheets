...
%  \setcounter{proficiency bonus}{2}
  ...
  \path ($(splash.south west)+(88mm,18.75mm)$) coordinate  (class sw);
  \path ($(splash.south west)+(88mm,9.7mm)$) coordinate  (race sw);
 
  \node [fill=splashfield,width=97mm,height=6mm,anchor=south west,at=(class sw)] {};
  \node [fill=splashfield,width=97mm,height=6mm,anchor=south west,at=(race sw)] {};

  \writesplash[at=(class sw)]{34mm}{CLASS + LEVEL}
  \writesplash[right of base=1mm of CLASS + LEVEL]{34mm}{BACKGROUND}
...
\begin{features}[anchor=south east,at=(current bounding box.south east)]{}
