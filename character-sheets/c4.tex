...
%  \fill [red] (hpbackground.north west) circle[radius=5pt];
  ...
  \node [dndhits,width=20mm,inside south east corner=of hpbackground,
         decorate=hpetc,
         dndlabel=HIT DICE] 
     (hitdice) 
     { \Large d8 }
...
%        {\textsf{\footnotesize HIT DICE}};
  ...
  \node [dndhits,fill=white,minimum width=72mm,left=of hitdice,decorate=hpetc,
         dnd/label={CURRENT HIT POINTS}] 
     (curhp)
     { \Large \bfseries\sffamily 10 }
     ;
%   \dndlabel{curhp}{CURRENT HIT POINTS}
