...
%%
%%% Caster/noncaster flag
%%\newif\ifcaster
%%\castertrue  % Set to true for caster example
%%
%%% Geometry parameters
%%\newlength\leftwidth
%%\newlength\rightwidth
%%\newlength\rightx
%%\setlength\leftwidth{6.5cm}
%%\setlength\rightwidth{12.8cm}
%%\setlength\rightx{7.15cm}
%%
...
%%  \pgfmathsetmacro{\widthcm}{#3/10}
%%  \pgfmathsetmacro{\heightcm}{#4/10}
%%  
%%  % Define coordinates
%%  \coordinate (ll) at (#1, #2);
%%  \coordinate (lr) at ($(ll) + (\widthcm, 0)$);
%%  \coordinate (ul) at ($(ll) + (0, \heightcm)$);
%%  \coordinate (ur) at ($(ll) + (\widthcm, \heightcm)$);
%%  
...
%%  \pgfmathsetmacro{\widthcm}{#3/10}
%%  \pgfmathsetmacro{\heightcm}{#4/10}
%%  \pgfmathsetmacro{\fboxsepcm}{\fboxsep/28.453} % Convert fboxsep from pt to cm
%%  
%%  % Fill background
%%  \fill[\dndsectioncolor] ($(#1, #2) + (0.1, 0.1)$) rectangle ($(#1, #2) + (\widthcm - 0.1, \heightcm - 0.1)$);
%%  
%%  % Draw the decorative box
%%  \dndbox{#1}{#2}{#3}{#4}
%%  
%%  % Place the title at the bottom center
%%  \node[font=\footnotesize\scshape, anchor=south] at ($(#1, #2) + (\widthcm/2, 0.05)$) {#5};
%%  
%%  % Calculate minipage width with fboxsep margins
%%  \pgfmathsetmacro{\minipagewidth}{\widthcm - 2*\fboxsepcm - 0.4}
%%  
%%  % Place content in a minipage at the TOP of the box with fboxsep spacing
%%  \node[anchor=north west, inner sep=0] at ($(#1, #2) + (\fboxsepcm + 0.2, \heightcm - \fboxsepcm - 0.2)$) {%
...
%%    \end{dndsection}
%%  \else
%%    \begin{dndsection}{\rightx}{128mm}{\rightwidth}{48mm}{ATTACKS}{attacks}
%%      \attacksbody
%%    \end{dndsection}
%%  \fi
...
%%}[\ignorespacesafterend]
%%
%%% MAGIC section (only for casters)
...
%%  
%%  % Proficiencies section (left side)
...
%%  \end{attackssection}
%%  
%%  % Magic section (right side, middle - only for casters)
%%  \begin{magicsection}
%%    \footnotesize
%%    \textbf{CANTRIPS}\\[0.3cm]
%%    
%%    \textbf{Friends [C]}\\
%%    You have advantage on Charisma checks against one creature for up to 1 minute.\\[0.3cm]
%%    
%%    \textbf{Ray of Frost}\\
%%    Make a spell attack (+4) against a target within 60 ft. to deal 1d8 cold damage and slow the target by 10 feet until your next turn starts.\\[0.3cm]
%%    
%%    \textbf{Vicious Mockery}\\
%%    A creature w/in 60 ft. must make a Wisdom save (DC 12) or take 1d4 psychic damage \& have disadvantage on their next attack roll on their next turn.\\[0.5cm]
%%    
%%    \textbf{1st LEVEL (2/day)}\\[0.3cm]
%%    
%%    \textbf{Bane [C]}\\
%%    Three creatures within 30 ft. must make Charisma saves (DC 12) or subtract -1d4 from all attacks and saves for up to 1 minute.\\[0.3cm]
%%    
%%    \textbf{Comprehend Languages [R]}\\
%%    For one hour, you understand all spoken and written languages.\\[0.3cm]
%%    
%%    \textbf{Healing Word [B]}\\
%%    A creature within 60 ft. regains 1d4+2 hit points.\\[0.3cm]
%%    
%%    \textbf{Heroism [C]}\\
%%    A creature you touch is immune to fear and gains 2 temporary hit points at the start of each round for up to 1 minute.
%%  \end{magicsection}
%%  
%%  % Features section (right side, bottom)
...
%%  
%%  % Calculate minipage width (with more margin)
%%  \pgfmathsetmacro{\minipagewidth}{\dndsectionwidth - 0.8}
%%  
%%  % Place content in a minipage at the TOP of the box
%%  \node[anchor=north west, inner sep=0] at (\dndsectionx + 0.4, \dndsectiony + \dndsectionheight - 0.4) {%
%%    \begin{minipage}{\minipagewidth cm}%
%%      \BODY%
%%    \end{minipage}%
%%  };
