...
{\node[at=(charname center),font={\rmfamily\LARGE\itshape},anchor=center]
  ...
  %%% central column: hit-point thing

\Large

      \node (hpbackground) 
        [stub rectangle,fill=hpetc,below=of splash,width=\colwidth, minimum height=87mm] 
       { };
...
\setdeltay\sectionheight{hpbackground.south}{equipment.north}

  \node (attacks) [columnbox,fill=attacks,height=\sectionheight,
                   anchor=north west,at=(hpbackground.south west)]
   {
