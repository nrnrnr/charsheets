...
\node[columnbox,text width=,width=\sectionwidth,% width=38.002mm,
    ...
    {\nodepart{label}SAVING THROWS\nodepart{text}%
     ...
     \scshape
     \begin{tabular}{@{}lll@{}}
      \dndsavingthrow{STR}&Strength    &\savemark{STR}\\
      \dndsavingthrow{DEX}&Dexterity   &\savemark{DEX}\\
      \dndsavingthrow{CON}&Constitution&\savemark{CON}\\
      \dndsavingthrow{INT}&Intelligence&\savemark{INT}\\
      \dndsavingthrow{WIS}&Wisdom      &\savemark{WIS}\\
      \dndsavingthrow{CHA}&Charisma    &\savemark{CHA}\\
    \end{tabular}}
  ;
