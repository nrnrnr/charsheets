...
\node[columnbox,text width=,width=\sectionwidth,% width=38.002mm,
    ...
    {\nodepart{label}SAVING THROWS\nodepart{text}%
     ...
     \scshape
     \begin{tabular}{@{}lll@{}}
      \dndmodifier{STR}&Strength    &\savemark{STR}\\
      \dndmodifier{DEX}&Dexterity   &\savemark{DEX}\\
      \dndmodifier{CON}&Constitution&\savemark{CON}\\
      \dndmodifier{INT}&Intelligence&\savemark{INT}\\
      \dndmodifier{WIS}&Wisdom      &\savemark{WIS}\\
      \dndmodifier{CHA}&Charisma    &\savemark{CHA}\\
    \end{tabular}}
  ;
