...
\node (stats background) 
      [fill=stats,width=25.3mm,height=166mm,anchor=north west]
      at (splash.west |- hpbackground.north)
 { };

\path (stats background.north west) ++(-0.3mm,-2mm) coordinate (first stat);
\renewcommand\nextstatloc{inside north west corner=of first stat}
...
\node (inspiration)
      [fill=white,draw,line width=1.2pt,decorated stub rectangle,width=38.001mm,height=8mm,
       right of upper corner=3.3mm of stats background]
...
\node[narrowcolumnbox,% width=38.002mm,
      fill=white,below=2mm of inspiration,align=center,
      height=35mm,
    ]
    (saving throws)
...
\path (proficiency bonus.south) ++ (0,-3mm) coordinate (prof top fit);
...
%below=3mm of proficiency bonus,
...
\node [anchor=south west,columnbox,minimum height=\sectionheight,
   ...
   (other proficiencies)
   at (bottom left |- equipment.south)
