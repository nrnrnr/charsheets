...
\else
  ...
  \node (proficiencies) [labeled stub rectangle,draw,width=38.002mm,height=\profheight,
...
\end{proflist}
  ...
  \nodepart{label}\vrule height 30pt width 1pt depth 0pt X: \textsc{Proficiencies}
   }
   ;
\fi
