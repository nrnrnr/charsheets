...
\node [statbox,draw=none,fill=none] (sample statbox) {};
\setdeltax\sectionwidth{sample statbox.east}{sample statbox.west}
...
\path (inspiration.south |- stats background.south) coordinate (prof bot fit);
  ...
  \node (proficiencies) [columnbox,text width=\tmpwidth-16pt,fill=proficiencies,height=\sectionheight,
